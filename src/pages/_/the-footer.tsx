      ...
      <div className="container flex flex-col justify-between gap-8 sm:flex-row sm:items-center">
        <div className="flex flex-col">
          ...
          <a href={"mailto:" + email} className="group/email">
            <div className="flex items-center gap-4 p-3">
              <EmailIcon className="group-hover/email:text-primary-400 h-6 w-6 text-primary" />
              <span className="flex-auto">
                <div>{email}</div>
              </span>
            </div>
          ...
          <a href={"tel:" + phone} className="group/phone">
            <div className="flex items-center gap-4 p-3">
              <PhoneIcon className="group-hover/phone:text-primary-400 h-6 w-6 text-primary" />
              <span className="flex-auto">
                <div>{phone}</div>
              </span>
            </div>
